...
| Nature (trees, rocks, foliage, 330 files) | [Nature Kit](https://kenney.nl/assets/nature-kit) | https://kenney.nl/media/pages/assets/nature-kit/37ac38a37b-1677698939/kenney_nature-kit.zip |
| Mini dungeon (chars rigged + weapons) | [Mini Dungeon](https://kenney.nl/assets/mini-dungeon) | https://kenney.nl/media/pages/assets/mini-dungeon/6cd72dc849-1785314274/kenney_mini-dungeon.zip |
| Prototype (chars, vehicles, animals, walls, animated) | [Prototype Kit](https://kenney.nl/assets/prototype-kit) | https://kenney.nl/media/pages/assets/prototype-kit/4d3b7073ed-1724832076/kenney_prototype-kit.zip |
| **Animated characters** — protagonists | [Animated Characters Protagonists](https://kenney.nl/assets/animated-characters-protagonists) | https://kenney.nl/media/pages/assets/animated-characters-protagonists/608191acc4-1774773108/kenney_animated-characters-protagonists.zip |
| **Animated characters** — survivors / zombies | [Animated Characters Survivors](https://kenney.nl/assets/animated-characters-survivors) | https://kenney.nl/media/pages/assets/animated-characters-survivors/27b16052a7-1774772958/kenney_animated-characters-survivors.zip |
| **Animated characters** — retro | [Animated Characters Retro](https://kenney.nl/assets/animated-characters-retro) | https://kenney.nl/media/pages/assets/animated-characters-retro/93305a3c49-1774772819/kenney_animated-characters-retro.zip |
| Particle sprites (80, CC0) | [Particle Pack](https://kenney.nl/assets/particle-pack) | https://kenney.nl/media/pages/assets/particle-pack/f8fe0f8cb8-1677578741/kenney_particle-pack.zip |
...
## 3b. Quaternius Universal (characters + 45–120 animations, CC0)

| Pack | Link | Notes |
|---|---|---|
| Universal Animation Library **Standard** (45 clips) | https://quaternius.itch.io/universal-animation-library ($0 name-your-price) · https://quaternius.com/packs/universalanimationlibrary.html | Humanoid rig, retargets to any Humanoid in Unity, Mixamo-compatible |
| Universal Base Characters (6 bodies, 20 hairstyles) | https://quaternius.com/packs/universalbasecharacters.html | FBX/glTF, pairs with UAL |
...
| Pack | Why |
|---|---|
| **POLYGON Starter Pack** (Synty) — https://assetstore.unity.com/packages/3d/environments/polygon-starter-pack-art-by-synty-156819 | Best-looking free stylized family: props, characters, environment, demo scene, URP |
| **Cartoon FX Remaster Free** (Jean Moreno) — https://assetstore.unity.com/packages/vfx/particles/cartoon-fx-remaster-free-109565 | 50+ stylized VFX prefabs, URP |
| Unity **Particle Pack** — https://assetstore.unity.com/packages/essentials/tutorial-projects/particle-pack-127325 | fire, smoke, explosions |
| ✗ Fantasy Kingdom in Unity 6 — **non-commercial EULA**: study its lighting, never ship its assets |

Standard Asset Store EULA = you may ship them in your game. Do not redistribute the files (keep them out of git: `Assets/_Game/Art/AssetStore/` in `.gitignore`).

## 3d. Free shader / rendering packages (GitHub, MIT-ish)

See [lookdev.md](lookdev.md): Delt06 URP toon, CristianQiu URP Outline + Volumetric Light (Unity 6), keijiro KinoAqua, ToonWater URP.

## 4. Poly Pizza (Blender MCP)

https://poly.pizza — 10k+ GLB, CC0/CC-BY. Not a modular kit. Props only. See [polypizza.md](polypizza.md).

## 4b. Poly Haven **models** + HDRIs (Blender MCP, no key, CC0)

`search_polyhaven_assets(asset_type="models")` → `download_polyhaven_asset(asset_id, "models", resolution="1k")`. PBR, mid-poly (10–50 k): decimate in the sanitize block and flatten materials for a low-poly slice, or use as hero props in `realistic-stylized`. HDRIs are allowed **as sky/ambient** (`GDS.LookDev.Apply(..., hdriPath)`), never on prop materials.

## 4c. Sketchfab CC0 (Blender MCP, free API token)

Set the token in the Blender MCP addon panel (free Sketchfab account). `search_sketchfab_models(query, downloadable=True)` → filter `license == "CC0"` (or CC-BY with attribution row in the ledger) → `download_sketchfab_model(uid)` → sanitize → `export_scene`. Prefer `low poly` / `stylized` in the query so it matches the kit family.
