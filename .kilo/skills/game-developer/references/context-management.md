...
Memoria su disco: `GAME_CONTEXT.md`, `GAME_TASKS.md`. Tagli sessione: [session-cuts.md](session-cuts.md).

## Quando tagliare

Non “se il contesto pesa”. Taglia **sempre** dopo la macrotask corrente. Vedi tabella in session-cuts.md.

Ogni 3 blender-asset nella stessa chat: STOP anche se la lista props non e finita.
...
Nuova chat. Leggi solo i due file. Esegui **una** macrotask. STOP. Non rifare GDD.
